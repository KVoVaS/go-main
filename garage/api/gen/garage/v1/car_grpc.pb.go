...
const (
	CarService_CreateCar_FullMethodName = "/garage.v1.CarService/CreateCar"
	CarService_GetCar_FullMethodName    = "/garage.v1.CarService/GetCar"
)
...
var CarService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "garage.v1.CarService",
